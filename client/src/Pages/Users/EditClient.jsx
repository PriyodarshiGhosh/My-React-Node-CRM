...
const EditClient = ({ open, setOpen }) => {
  ...
  //////////////////////////////////////// STATES /////////////////////////////////////
  const [clientData, setClientData] = useState(currentClient || initialClientState);
  const [validationErrors, setValidationErrors] = useState({});

  //////////////////////////////////////// USE EFFECTS /////////////////////////////////////
  useEffect(() => {
    setClientData(currentClient || initialClientState);
  }, [currentClient]);
  ...
  const validateForm = () => {
    ...
    if (email && email && !/\S+@\S+\.\S+/.test(email)) errors.email = "Email is invalid";
